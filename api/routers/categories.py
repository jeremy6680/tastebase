...
@router.post("/{item_id}/category", response_model=Category, dependencies=[Depends(verify_api_key)])
def upsert_category(
    item_id: str,
...
@batch_router.post("/batch", response_model=list[Category], dependencies=[Depends(verify_api_key)])
